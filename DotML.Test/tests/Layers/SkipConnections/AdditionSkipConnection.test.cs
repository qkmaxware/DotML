...
[TestClass]
public class AdditionSkipConnectionTest {

    [TestMethod]
    public void TestSimple() {
        var capture = new InputCapture(new Shape3D(1, 5, 5));
        var residual = BatchedFeatureSet<double>.FromJagged(
            [
                [
                    [
                        [
