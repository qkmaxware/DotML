...
public static class TensorConvert
{
    ...
    /// <returns>tensor of floats</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tensor<UInt64> ToUInt64<TNumFrom>(this Tensor<TNumFrom> self, IFormatProvider format)
    where TNumFrom : INumber<TNumFrom>, IConvertible
        => self.ElementWise(x => x.ToUInt64(format));
    ...
    /// <returns>tensor of elements of type <see cref="TNumTo"/></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tensor<TNumTo> ToType<TNumFrom, TNumTo>(this Tensor<TNumFrom> self, IFormatProvider format)
    where TNumFrom : INumber<TNumFrom>, IConvertible
    where TNumTo : INumber<TNumTo>
        => self.ElementWise(x => (TNumTo)x.ToType(typeof(TNumTo), format));
    ...
    /// <returns>tensor of floats</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tensor<float> ToFloat<TNumFrom>(this Tensor<TNumFrom> self, IFormatProvider format)
    where TNumFrom : INumber<TNumFrom>, IConvertible
        => self.ElementWise(x => x.ToSingle(format));
    ...
    /// <returns>tensor of floats</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tensor<double> ToDouble<TNumFrom>(this Tensor<TNumFrom> self, IFormatProvider format)
    where TNumFrom : INumber<TNumFrom>, IConvertible
        => self.ElementWise(x => x.ToDouble(format));
    ...
    /// <returns>tensor of floats</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tensor<decimal> ToDecimal<TNumFrom>(this Tensor<TNumFrom> self, IFormatProvider format)
    where TNumFrom : INumber<TNumFrom>, IConvertible
        => self.ElementWise(x => x.ToDecimal(format));
    ...
    /// <returns>tensor of floats</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tensor<SByte> ToInt8<TNumFrom>(this Tensor<TNumFrom> self, IFormatProvider format)
    where TNumFrom : INumber<TNumFrom>, IConvertible
        => self.ElementWise(x => x.ToSByte(format));
    ...
    /// <returns>tensor of floats</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tensor<Int16> ToInt16<TNumFrom>(this Tensor<TNumFrom> self, IFormatProvider format)
    where TNumFrom : INumber<TNumFrom>, IConvertible
        => self.ElementWise(x => x.ToInt16(format));
    ...
    /// <returns>tensor of floats</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tensor<Int32> ToInt32<TNumFrom>(this Tensor<TNumFrom> self, IFormatProvider format)
    where TNumFrom : INumber<TNumFrom>, IConvertible
        => self.ElementWise(x => x.ToInt32(format));
    ...
    /// <returns>tensor of floats</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tensor<Int64> ToInt64<TNumFrom>(this Tensor<TNumFrom> self, IFormatProvider format)
    where TNumFrom : INumber<TNumFrom>, IConvertible
        => self.ElementWise(x => x.ToInt64(format));
    ...
    /// <returns>tensor of floats</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tensor<Byte> ToUInt8<TNumFrom>(this Tensor<TNumFrom> self, IFormatProvider format)
    where TNumFrom : INumber<TNumFrom>, IConvertible
        => self.ElementWise(x => x.ToByte(format));
    ...
    /// <returns>tensor of floats</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tensor<UInt16> ToUInt16<TNumFrom>(this Tensor<TNumFrom> self, IFormatProvider format)
    where TNumFrom : INumber<TNumFrom>, IConvertible
        => self.ElementWise(x => x.ToUInt16(format));
    ...
    /// <returns>tensor of floats</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Tensor<UInt32> ToUInt32<TNumFrom>(this Tensor<TNumFrom> self, IFormatProvider format)
    where TNumFrom : INumber<TNumFrom>, IConvertible
        => self.ElementWise(x => x.ToUInt32(format));
}