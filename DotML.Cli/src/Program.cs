...
public class Program {
    public static int Main() {
        ...
        return 
            Parser
            .Default
            .ParseArguments<Build, Import, List, Describe, Remove, Modify, Export, Fit, Report, Test, Run>(Environment.GetCommandLineArgs().Skip(1))
            .MapResult(
                (Build cmd)     => cmd.TryDoAction(appData),
                (Import cmd)    => cmd.TryDoAction(appData),
                ...
                (Export cmd)    => cmd.TryDoAction(appData),
