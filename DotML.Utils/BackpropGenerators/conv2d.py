...
# Step 1: Make layer
layer = nn.Conv2d(in_channels=256, out_channels=512, kernel_size=3, stride=2, padding=1) 

# Step 2: Create random input tensor
input = torch.randn(1, 256, 14, 14, requires_grad=True) # 1 batch, 3 channel, 5x5 feature
